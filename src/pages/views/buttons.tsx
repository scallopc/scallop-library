...
export default function ButtonsPageView() {
    const primary =
        '<Button variant="primary" size="small" label="button name" />';
    const outline =
        '<Button variant="outline" size="medium" label="button name" />';
    const text = '<Button variant="text" size="large" />';
    const textIcon =
        '<Button variant="text" size="small" label="button name" icon="fa-regular fa-plus" />';
    const disabled =
        '<Button variant="primary" size="small" label="button name" disabled />';
            ...
            <Box>
                ...
                <DocumentationContainer>
                    ...
                    <Content>
                        ...
                        <SmallDetail>
                            {" "}
                            To display only an icon, do not insert label. The
                            library used for icons is"FontAwesomeIcon"
                        </SmallDetail>
                    ...
                    <Content>
                        ...
                        <Table>
                            ...
                            <TableRow>
                                ...
                                <div>string</div>
                                <div>
                                    Defines the button type, valid options are
                                    "primary", "outline" and "text"
                                </div>
                            </TableRow>
                            <TableRow>
                                <div>disabled</div>
                                <div>boolean</div>
                                <div>
                                    Defines if the button is disabled, valid
